...
import { getSaleHistoryAdm, deleteSaleHistoryBy_id } from '../../../api/history';
...
const HistoryViewAdm = () => {
  ...
  React.useEffect(() => {
    ...
    if (userJson) {
      ...
      setUserId(userIdC);
      // getSaleHistoryAdm(userIdC);

      getSaleHistoryAdm().then((response) => {
